...
;;(test (interp (desugar (parse '{{{fun {x} x} {fun {x} {+ x 5}}} 3})) (mtSub)) (num 8))
;;(test (interp (desugar (parse '{with {x 3} {fun {y} {+ x y}}})) (mtSub)) (fun 'y (add (num 3) (id 'y))))
;;(test (interp (desugar (parse '{with {x 3} {with {f {fun {y} {+ x y}}} {with {x 5} {f 4}}}})) (mtSub)) (num 7))
